...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-14 12:13`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1e135681-d8ea-471b-8514-ddee0e82500e.git
$ cd 1e135681-d8ea-471b-8514-ddee0e82500e
```
